...
set CLASSPATH=%APP_HOME%\lib\deployment-automation-client-2.0.0.jar;%APP_HOME%\lib\.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MENU_OPTS% -classpath "%CLASSPATH%" com.appiancorp.ps.plugins.automatedimport.remote.DeployApplication %CMD_LINE_ARGS%
